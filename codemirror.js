...
var memo = {
text: line.text, width: display.scroller.clientWidth,
...
if (!set) return;
var anti = {
events: [], fromBefore: set.fromAfter, toBefore: set.toAfter,
...
var set = arr[i];
nw.push({
events: nwelt = [], fromBefore: set.fromBefore, toBefore: set.toBefore,
...
function StringStream(str, tabSize) {
...
peek: function () { return this.str.charAt(this.pos) || undefined; },
next: function () {
...
column: function () { return countColumn(this.str, this.start, this.tabSize); },
indentation: function () { return countColumn(this.str, null, this.tabSize); },
...
current: function () { return this.str.slice(this.start, this.pos); }
};
...
function countColumn(str, end, tabSize) {
if (end == null) {
end = str.search(/[^\s\u00a0]/);
if (end == -1) end = str.length;
}
for (var i = 0, n = 0; i < end; ++i) {
if (str.charAt(i) == "\t") n += tabSize - (n % tabSize);
else ++n;
}
return n;
}
...
var splitLines = ("\n\nb".split(/\n/).length != 3) ? (function (str) {
var pos = 0, result = [], l = str.length;
while (pos <= l) {
var nl = str.indexOf("\n", pos);
if (nl == -1) nl = str.length;
var line = str.slice(pos, str.charAt(nl - 1) == "\r" ? nl - 1 : nl);
